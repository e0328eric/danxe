...
syntax keyword glasmKeywords jg jge jl jle
syntax keyword glasmKeywords rjmp rjt rjf rje rjne
syntax keyword glasmKeywords rjg rjge rjl rjle
syntax keyword glasmKeywords call ret swap sswap rot
...
syntax keyword glasmKeywords inc dec store load
...
syntax match glasmLabel		"\v\<([a-zA-Z0-9]|_|-|\?)*\>\n"he=e-1
